...
> [!WARNING]
> **Historical snapshot; not a current completion report.** “10/10” below records
> an earlier work session and does not mean the present repository is complete,
> production-ready, or fully verified. See [README.md](README.md) for current
> behavior and [docs/DEVELOPMENT_PLAN.md](docs/DEVELOPMENT_PLAN.md) for the active
> definition of done and verification ledger.
