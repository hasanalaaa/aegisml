...
export const alt = "AegisML — Static analysis for AI model artifacts";
    ...
    (
      ...
      >
        ...
        <div style={{ color: "#A8A8C4", fontSize: 22, textAlign: "center", maxWidth: 720, lineHeight: 1.5, marginBottom: 52, display: "flex" }}>
          Inspect model bytes, serialization, and container structure without executing the model
        </div>

        <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
          {["GGUF", "SafeTensors", "Pickle", "PyTorch", "Local-first", "MIT"].map((badge) => (
            <div key={badge} style={{
